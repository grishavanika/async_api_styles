...
struct Co_Await_All<std::index_sequence<Is...>, Ts...>
{
    ...
    void await_suspend(std::coroutine_handle<> waiting_coro) noexcept
    {
...
struct Co_CurlAsyncMany<std::index_sequence<Is...>>
{
    ...
    template<auto I>
    static bool on_response(WaitState& wait_state, std::string&& response)
    {
    ...
    std::array<std::string, Count> await_resume() noexcept
    {
